...
<form class="form" action="x.php" method="post" name="form_220184261971454" id="220184261971454" accept-charset="utf-8" autocomplete="on">
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      <li class="form-line" data-type="control_image" id="id_52">
        <div id="cid_52" class="form-input-wide">
          <div style="text-align:center">
            <img alt="" class="form-image" style="border:0" src="pet.jpg" height="278px" width="410px" data-component="image" />
          </div>
        </div>
      </li> 
      <li class="form-line" data-type="control_radio" id="id_15">
        <label class="form-label form-label-left form-label-auto"  id="label_15" for="input_15"> I am reporting a pet that was </label>
      ...
      <li class="form-line" data-type="control_datetime" id="id_73">
        <label class="form-label form-label-left form-label-auto" id="label_73" for="month_73" > Date </label>
        <div id="cid_73" class="form-input">
          <div data-wrapper-react="true" class="extended notLiteMode">
            ...
            <span class="form-sub-label-container" style="vertical-align:top">
              ...
              <label class="form-sub-label" for="input_73_pick" style="border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;white-space:nowrap" aria-hidden="true"> Date Picker Icon </label>
            </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line jf-required" data-type="control_address" id="id_7">
        <label class="form-label form-label-left form-label-auto" id="label_7" for="input_7_addr_line1" name = "location">
         Location where your pet is lost
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_7" class="form-input jf-required">
          <div summary="" class="form-address-table jsTest-addressField">
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_7_addr_line2" name="line2" class="form-textbox form-address-line" data-defaultvalue="" autoComplete="section-input_7 address-line2" value="" data-component="address_line_2" aria-labelledby="label_7 sublabel_7_addr_line2" required/>
        ...
        <div id="cid_44" class="form-input">
          <div class="form-single-column" role="group" aria-labelledby="label_44" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left">
              ...
              <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_0" name="detail" value="Wearing collar or harness." />
              <label id="label_input_44_0" for="input_44_0">Wearing collar or harness. </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_1" name="detail" value="Wearing ID tags" />
              <label id="label_input_44_1" for="input_44_1">Wearing ID tags. </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_2" name="detail" value="No collar" />
              <label id="label_input_44_2" for="input_44_2"> No collar.</label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
                <span class="dragger-item">
                </span>
                <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_3" name="detail" value="Microchipped" />
                <label id="label_input_44_3" for="input_44_3"> Microchipped.</label>
              </span>
              <span class="form-checkbox-item" style="clear:left">
                <span class="dragger-item">
                </span>
                <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_4" name="detail" value="Not microchipped." />
                <label id="label_input_44_4" for="input_44_4"> Not microchipped.</label>
              </span>
              <span class="form-checkbox-item" style="clear:left">
                <span class="dragger-item">
                </span>
                <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_5" name="detail" value="Has not yet been scanned for a microchip." />
                <label id="label_input_44_5" for="input_44_5"> Has not yet been scanned for a microchip.</label>
              </span>
              <span class="form-checkbox-item" style="clear:left">
                <span class="dragger-item">
                </span>
                <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_6" name="detail" value="Has an ID tattoo." />
                <label id="label_input_44_6" for="input_44_6"> Has an ID tattoo.</label>
              </span>
              <span class="form-checkbox-item" style="clear:left">
                <span class="dragger-item">
                </span>
                <input type="checkbox" aria-describedby="label_44" class="form-checkbox" id="input_44_7" name="detail" value="Bird wearing a band on it's leg." />
                <label id="label_input_44_7" for="input_44_7"> Bird wearing a band on it's leg.</label>
              </span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_fileupload" id="id_28">
        <label class="form-label form-label-top" id="label_28" for="input_28">
          Picture of Pet - A good picture, preferably a full body of your pet is important for flyers and on our posts. PLEASE crop out any distractions such as people, children furniture and other pets. (Please make sure the file is in image format (JPG) and less than 2000kb)
          <span class="form-required">
            *
          </span>
        </label>
      ...
      <li class="form-line" data-type="control_textarea" id="id_28">
        ...
        <div id="cid_28" class="form-input">
          <textarea id="input_28" class="form-textarea" name="q28_pleaseDescribe" cols="40" rows="6" data-component="textarea" aria-labelledby="label_28"></textarea>
        </div>
        ...
        <div id="cid_51" class="form-input-wide">
          <div style="margin-left:156px" data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
            <button id="input_51" type="submit"  name = "submit" class="form-submit-button submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
              Submit
            </button>
          </div>
        </div>
